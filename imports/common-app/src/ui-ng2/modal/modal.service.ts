...
export class ModalService {
  private static modalSubject:Subject<ModalEvent> = new Subject<ModalEvent>();  // A subject for all modals (for managing display)
  ...
  static open(component:Type, selector:string, params:Object=undefined):Promise<any> {
