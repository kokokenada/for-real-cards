...
export class AccountsAdminActions {
  ...
  static deleteRequest(userId:string):void {
    ReduxModuleCombiner.ngRedux.dispatch({ type: AccountsAdminActions.DELETE_REQUEST, payload: {userId}});
  }

  static deleteSuceeded(userId:string):void {
    ReduxModuleCombiner.ngRedux.dispatch({ type: AccountsAdminActions.DELETE_SUCCEEDED, payload: {userId}});
  }

  static impersonateRequest(userId:string):void {
    ReduxModuleCombiner.ngRedux.dispatch({ type: AccountsAdminActions.IMPERSONATE_REQUEST, payload: {userId}});
  }

  static impersonateSuceeded(userId:string):void {
    ReduxModuleCombiner.ngRedux.dispatch({ type: AccountsAdminActions.IMPERSONATE_SUCCEEDED, payload: {userId}});
  }

  static userRoleChangeRequest(userId:string, role:string, add:boolean):void {
    ReduxModuleCombiner.ngRedux.dispatch({ type: AccountsAdminActions.USER_ROLE_CHANGE_REQUEST, payload: {userId, role, add}});
  }

  static userRoleChangeSuceeded(userId:string, role:string, add:boolean):void {
    ReduxModuleCombiner.ngRedux.dispatch({ type: AccountsAdminActions.USER_ROLE_CHANGE_SUCCEEDED, payload: {userId, role, add}});
  }

  static systemRoleChangeRequest(role:string, add:boolean):void {
    ReduxModuleCombiner.ngRedux.dispatch({ type: AccountsAdminActions.SYSTEM_ROLE_CHANGE_REQUEST, payload: {role, add}});
  }

  static systemRoleChangeSuceeded(role:string, add:boolean):void {
    ReduxModuleCombiner.ngRedux.dispatch({ type: AccountsAdminActions.SYSTEM_ROLE_CHANGE_SUCCEEDED, payload: {role, add}});
  }
}
